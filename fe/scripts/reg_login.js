...
function validateUser(base64User) {
  ...
  $.ajax({
    ...
    headers: {
      ...
      // "Authorization": "Basic "+`${base64User}`S
    },
    success: function (res) {
      console.log("In post callback: ", res);
...
function postUserToServerReturnLogin(user) {
  $.ajax({
    ...
    success: function () {
      ...
      clearRegisterInputs();
      // updateMessagesFromServer() <<--not complete
    },
    fail: function (error) {
      // what do we do here?
    },

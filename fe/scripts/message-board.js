...
exampleMessage = {
  messageText: "Hi, this is a test message 0",
  author: "Tony Enerson",
  messageDate: "2020-05-19",
};

function addMessageToPage(message) {
  replyID = "RP" + message._id;
  messID = "MS" + replyID;
  let messageHtml = `<div class="message">${message._id}, ${message.messageText}
...
function updatePageMessages2(messages) {
  cleanOutElement("messagesArea");
  let post;
  let tempThreadID;
  messages.forEach(function (message) {
    ...
    if (message.threadID === message.parentID) {
      tempThreadID = message.threadID;
      post = message;
    } else {
      post.reply = message;
    }
    if (tempThreadID !== message.threadID) {
      console.log("POST: ",post)
      return addMessageToPage(post);
    }
  });
}
...
testMessages = [
  ...
  {
    messageText: "Hi, this is a test message 1",
    author: "Chris Desmarais",
    messageDate: "2020-05-20",
  },
  {
    messageText: "Hi, this is a test message 2",
    author: "Sheldon Manabat",
    messageDate: "2020-05-20",
  },
  {
    messageText: "Hi, this is a test message 3",
    author: "Tony Enerson",
    messageDate: "2020-05-21",
  },
  {
    messageText: "Hi, this is a test message 4",
    author: "Tony Enerson",
    messageDate: "2020-05-22",
  },
];
